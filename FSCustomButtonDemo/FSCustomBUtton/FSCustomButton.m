...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    switch (self.buttonLayoutType) {
        case FSCustomButtonLayoutTypeTop:
        case FSCustomButtonLayoutTypeBottom: {
        ...
        case FSCustomButtonLayoutTypeLeft:
        case FSCustomButtonLayoutTypeRight: {
            if (self.buttonLayoutType == FSCustomButtonLayoutTypeLeft && self.titleLabel.numberOfLines == 1) {
...
- (void)setButtonLayoutType:(FSCustomButtonLayoutType)buttonLayoutType
{
